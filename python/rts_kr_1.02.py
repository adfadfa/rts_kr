...
class WindowClass(QMainWindow, form_class) :
    def __init__(self) :
        ...
        self.global_refresh.clicked.connect(self.OPEN_LOADING)
        #EXEC KUF
    ...
    def OPEN_LOADING(self) :
        print("로딩바 호출")
        self.loading_frame.setGeometry(280,230,311,100)


    def CLOSE_LOADING(self) :
        self.loading_frame.setGeometry(280,230,311,0)
    ...
    def GOOGLESHEET(self):
        ...
        self.kuf_spreadsheeturl = 'https://docs.google.com/spreadsheets/d/1LoWXw0wXBQw_xBfMP4HBC1yvT_7p7_36nLFFWeiTmwY/edit#gid=0'
    ...
    def RANK_UPDATE(self, game, myrace, myname,yourname, yourace, gamemap,outcome) :
        ...
        #open loading
        print("로딩바 출력되어야함")
        self.loading_frame.setGeometry(250,220,311,100)
        print("출력되었니?")
        #ragistry user
